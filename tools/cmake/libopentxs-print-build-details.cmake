...
macro(libopentxs_print_build_details)
  ...
  if(OT_USE_PSTL)
    if(OT_PSTL_NEEDS_TBB)
      message(STATUS "parallel algorithms:      STL (via TBB)")
    else()
      message(STATUS "parallel algorithms:      STL")
    endif()
  elseif(OT_WITH_TBB)
    message(STATUS "parallel algorithms:      TBB")
  else()
    message(STATUS "parallel algorithms:      none")
  endif()
