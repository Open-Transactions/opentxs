...
{
enum class OP : std::underlying_type_t<OP> {
    ZERO = 0,
    PUSHDATA_1 = 1,
    PUSHDATA_2 = 2,
    PUSHDATA_3 = 3,
    ...
    NOP9 = 184,
    NOP10 = 185,
    UTXOTOKENCATEGORY = 206,
    UTXOTOKENCOMMITMENT = 207,
    UTXOTOKENAMOUNT = 208,
    OUTPUTTOKENCATEGORY = 209,
    OUTPUTTOKENCOMMITMENT = 210,
    OUTPUTTOKENAMOUNT = 211,
    PREFIX_TOKEN = 239,
    PUBKEYHASH = 253,
    PUBKEY = 254,
    INVALIDOPCODE = 255,
