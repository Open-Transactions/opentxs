...
#include "opentxs/protobuf/syntax/BlockchainPreviousOutput.hpp"  // IWYU pragma: associated

#include <opentxs/protobuf/BlockchainPreviousOutput.pb.h>  // IWYU pragma: keep
