...
auto paymentworkflowstate_map() noexcept -> const PaymentWorkflowStateMap&
{
    ...
    using enum protobuf::PaymentWorkflowState;
...
auto paymentworkflowtype_map() noexcept -> const PaymentWorkflowTypeMap&
{
    ...
    using enum protobuf::PaymentWorkflowType;
    ...
    -> protobuf::PaymentWorkflowState
{
    try {
        ...
        return protobuf::PAYMENTWORKFLOWSTATE_ERROR;
    }
}
    ...
    -> protobuf::PaymentWorkflowType
{
    try {
        ...
        return protobuf::PAYMENTWORKFLOWTYPE_ERROR;
    }
}
