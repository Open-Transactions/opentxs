...
{
/// This class adapts an externally-constructed
/// boost::container::pmr::memory_resource* to a std::pmr::memory_resource
///
...
/// This constructs a boost::container::pmr::memory_resource and wraps it in a
...
/// This class adapts an externally-constructed std::pmr::memory_resource* to a
