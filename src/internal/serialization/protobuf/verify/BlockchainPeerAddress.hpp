...
{
auto CheckProto_1(const BlockchainPeerAddress& input, const bool silent)
    -> bool;
auto CheckProto_2(const BlockchainPeerAddress& input, const bool silent)
    -> bool;
auto CheckProto_3(const BlockchainPeerAddress& input, const bool silent)
    -> bool;
auto CheckProto_4(const BlockchainPeerAddress& input, const bool silent)
    -> bool;
auto CheckProto_5(const BlockchainPeerAddress& input, const bool silent)
    -> bool;
auto CheckProto_6(const BlockchainPeerAddress& input, const bool silent)
    -> bool;
auto CheckProto_7(const BlockchainPeerAddress& input, const bool silent)
    -> bool;
auto CheckProto_8(const BlockchainPeerAddress& input, const bool silent)
    -> bool;
auto CheckProto_9(const BlockchainPeerAddress& input, const bool silent)
    -> bool;
