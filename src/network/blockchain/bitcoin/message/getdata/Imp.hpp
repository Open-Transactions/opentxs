...
{
class Message final : public getdata::MessagePrivate,
...
public:
    ...
    auto get() const noexcept
        -> std::span<const internal::Getdata::value_type> final
    {
        return payload_;
    }
    ...
    auto get() noexcept -> std::span<internal::Getdata::value_type> final
    {
        return payload_;
    }
...
private:
    Vector<internal::Getdata::value_type> payload_;
