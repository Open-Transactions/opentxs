...
{
class Message final : public cfheaders::MessagePrivate,
...
public:
    ...
    auto get() const noexcept
        -> std::span<const internal::Cfheaders::value_type> final
    {
        return payload_;
    }
    auto IsValid() const noexcept -> bool final { return true; }
    auto Previous() const noexcept
        -> const opentxs::blockchain::cfilter::Header& final
    {
        return previous_;
    }
    ...
    auto get() noexcept -> std::span<internal::Cfheaders::value_type> final
    {
        return payload_;
    }
...
private:
    static constexpr auto prefix_ = sizeof(FilterPrefixChained);

    const opentxs::blockchain::cfilter::Type type_;
    const opentxs::blockchain::block::Hash stop_;
    const opentxs::blockchain::cfilter::Header previous_;
    Vector<internal::Cfheaders::value_type> payload_;
