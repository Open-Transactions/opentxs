...
#include "network/blockchain/bitcoin/message/getcfheaders/Imp.hpp"  // IWYU pragma: associated
...
Message::Message(
    ...
    , getcfheaders::MessagePrivate(alloc)
...
Message::Message(const Message& rhs, allocator_type alloc) noexcept
    ...
    , getcfheaders::MessagePrivate(rhs, alloc)
