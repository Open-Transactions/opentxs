...
#include "network/blockchain/bitcoin/message/notfound/Imp.hpp"  // IWYU pragma: associated
          ...
          [&] {
              ...
              for (auto n = 0_uz; n < count; ++n) {
                  static const auto size =
                      internal::Notfound::value_type::EncodedSize;
...
Message::Message(const Message& rhs, allocator_type alloc) noexcept
    ...
    , notfound::MessagePrivate(rhs, alloc)
    ...
    noexcept(false) -> void
{
    ...
    static const auto size = internal::Notfound::value_type::EncodedSize;
