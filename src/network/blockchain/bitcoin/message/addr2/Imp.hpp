...
{
class Message final : public addr2::MessagePrivate,
                      public implementation::Message
{
public:
    using AddressVector = Vector<network::blockchain::Address>;
...
private:
    ...
    AddressVector payload_;
    mutable std::optional<std::size_t> cached_size_;
    mutable std::optional<Vector<Bip155>> cached_items_;
