...
{
class Message final : public inv::MessagePrivate, public implementation::Message
{
public:
    ...
    auto get() const noexcept
        -> std::span<const internal::Inv::value_type> final
    {
        return payload_;
    }
    auto IsValid() const noexcept -> bool final { return true; }

    auto get() noexcept -> std::span<internal::Inv::value_type> final
    {
        return payload_;
    }
...
private:
    Vector<internal::Inv::value_type> payload_;
