...
auto GetDefinition(UnitType in) noexcept -> const Definition&
{
    ...
    static const auto map = DefinitionMap{
        ...
        {UnitType::Eth,
         {u8"ETH"_cstr,
          {
              {u8"Gether"_cstr, {"", u8"Gether"_cstr, {{10, 27}}, 0, 18}},
              {u8"Mether"_cstr, {"", u8"Mether"_cstr, {{10, 24}}, 0, 15}},
              {u8"Kether"_cstr, {"", u8"Kether"_cstr, {{10, 21}}, 0, 12}},
              {u8"Ether"_cstr, {"", u8"Ether"_cstr, {{10, 18}}, 0, 9}},
              {u8"Finney"_cstr, {"", u8"Finney"_cstr, {{10, 15}}, 0, 6}},
              {u8"Szabo"_cstr, {"", u8"Szabo"_cstr, {{10, 12}}, 0, 3}},
              {u8"Gwei"_cstr, {"", u8"Gwei"_cstr, {{10, 9}}, 0, 0}},
              {u8"Mwei"_cstr, {"", u8"Mwei"_cstr, {{10, 6}}, 0, 0}},
              {u8"Kwei"_cstr, {"", u8"Kwei"_cstr, {{10, 3}}, 0, 0}},
              {u8"wei"_cstr, {"", u8"wei"_cstr, {{10, 0}}, 0, 0}},
          }}},
