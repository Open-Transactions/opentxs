...
#include "core/contract/peer/request/Base.hpp"  // IWYU pragma: associated
...
auto Request::calculate_id() const -> identifier_type
{
...
auto Request::IDVersion() const -> SerializedType
{
...
auto Request::SigVersion() const -> SerializedType
{
...
auto Request::update_signature(const PasswordPrompt& reason) -> bool
{
...
auto Request::validate() const -> bool
{
    auto validNym = false;
...
auto Request::verify_signature(const proto::Signature& signature) const -> bool
{
