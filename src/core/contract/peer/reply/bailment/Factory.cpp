...
#include "core/contract/peer/reply/bailment/Implementation.hpp"
...
{
    using ReturnType = contract::peer::reply::bailment::Implementation;
    using BlankType = contract::peer::reply::BailmentPrivate;
    ...
    try {
        ...
        pmr.construct(
            out, api, signer, initiator, signer->ID(), request, terms);
