...
#include "core/contract/peer/reply/bailmentnotice/Implementation.hpp"  // IWYU pragma: associated
...
auto Implementation::id_form() const noexcept -> serialized_type
{
    ...
    auto& bailmentnotice = *out.mutable_notice();
    bailmentnotice.set_version(Version());
    bailmentnotice.set_ack(value_);
