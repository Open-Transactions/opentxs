...
#include "core/contract/peer/reply/bailmentnotice/Implementation.hpp"
...
{
    using ReturnType = contract::peer::reply::bailmentnotice::Implementation;
    using BlankType = contract::peer::reply::BailmentNoticePrivate;
