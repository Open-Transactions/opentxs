...
#include "core/contract/peer/reply/verification/Implementation.hpp"
...
{
    using ReturnType = contract::peer::reply::verification::Implementation;
    using BlankType = contract::peer::reply::VerificationPrivate;
    ...
    try {
        ...
        pmr.construct(
            out, api, signer, initiator, signer->ID(), request, response);
