...
public:
    ...
    auto Tags() const noexcept -> const std::pmr::set<node::TxoTag> final
    {
        return cache_.tags();
    }
...
private:
    struct Cache {
        ...
        auto keys() const noexcept -> std::pmr::vector<crypto::Key>;
        ...
        auto tags() const noexcept -> std::pmr::set<node::TxoTag>;
