        ...
        {blockchain::Type::Bitcoin,
         {
             ...
             250,
             {
                 ...
                 {Bit6, network::blockchain::bitcoin::Service::BitcoinCash},
                 {Bit7, network::blockchain::bitcoin::Service::CompactFilters},
                 {Bit8, network::blockchain::bitcoin::Service::Segwit2X},
                 {Bit11, network::blockchain::bitcoin::Service::Limited},
             },
             {
        ...
        {blockchain::Type::BitcoinCash,
         {
             ...
             25,
             {
                 ...
                 {Bit5, network::blockchain::bitcoin::Service::XThin},
                 {Bit6, network::blockchain::bitcoin::Service::BitcoinCash},
                 {Bit7, network::blockchain::bitcoin::Service::Graphene},
                 {Bit8, network::blockchain::bitcoin::Service::WeakBlocks},
                 {Bit9, network::blockchain::bitcoin::Service::CompactFilters},
                 {Bit10, network::blockchain::bitcoin::Service::XThinner},
                 {Bit11, network::blockchain::bitcoin::Service::Limited},
                 {Bit25, network::blockchain::bitcoin::Service::Avalanche},
             },
             {
