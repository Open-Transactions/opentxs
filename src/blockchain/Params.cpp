        ...
        ChainMap{
            ...
            {blockchain::Type::eCash,
             {true,
              ...
              {
                  {cfilter::Type::Basic_BCHVariant,
                   {"9f3c30f0c37fb977cf3e1a3173c631e8ff119ad3088b6f5b2bced08021"
                    "39c20"
                    "2",
                    "017fa880"}},
                  {cfilter::Type::ES,
                   {"fad52acc389a391c1d6d94e8984fe77323fbda24fb31299b88635d7bee"
                    "0278e"
                    "8",
...
public:
    ...
    ChainDataPrivate(const Data& data, blockchain::Type chain) noexcept
        ...
        , checkpoint_(
              data.checkpoint_.height_,
              {IsHex, data.checkpoint_.block_hash_})
        , checkpoint_prior_(
              checkpoint_.height_ - 1,
              {IsHex, data.checkpoint_.previous_block_hash_})
        , checkpoint_cfheader_(IsHex, data.checkpoint_.filter_header_)
