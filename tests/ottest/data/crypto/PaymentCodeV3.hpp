...
namespace ottest
{
struct OPENTXS_EXPORT PaymentCodeVectorV3 {
...
struct OPENTXS_EXPORT PaymentCodeVectorsV3 {
...
OPENTXS_EXPORT auto GetPaymentCodeVector3() noexcept
    -> const PaymentCodeVectorsV3&;
}  // namespace ottest
