...
public:
    ...
    ot::UnallocatedCString seed_;
    ot::crypto::SeedID fingerprint_;
    ot::UnallocatedCString nym_id_0_, paycode_0_, nym_id_1_, paycode_1_,
        nym_id_2_, paycode_2_, nym_id_3_, paycode_3_;
