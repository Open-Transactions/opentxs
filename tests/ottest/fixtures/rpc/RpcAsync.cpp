...
std::unique_ptr<OTZMQListenCallback> RpcAsync::notification_callback_{
    nullptr};
std::unique_ptr<OTZMQSubscribeSocket> RpcAsync::notification_socket_{
    nullptr};
identifier::Nym RpcAsync::receiver_nym_id_{
...
identifier::Generic RpcAsync::workflow_id_{
    ot::identifier::Generic::Factory()};
identifier::Notary RpcAsync::intro_server_id_{
    ot::identifier::Notary::Factory()};
identifier::Notary RpcAsync::server_id_{
    ot::identifier::Notary::Factory()};
