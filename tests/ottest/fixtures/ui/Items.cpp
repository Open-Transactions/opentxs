...
auto Value::index() const noexcept -> std::ptrdiff_t
{
    return row_index_;
}

auto Value::Last() const noexcept -> bool
{
    return false;
}
...
auto Value::Valid() const noexcept -> bool
{
    return false;
}
...
auto Value::AddChildren(opentxs::ui::implementation::CustomData&& data)
    noexcept -> void
{
